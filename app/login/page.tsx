...
export default function LoginPage() {
  ...
  const { signInWithGoogle, signInWithEmail, signUpWithEmail, error, clearError, loading: authLoading } = useAuth();
    ...
    <div className="min-h-screen bg-gradient-to-br from-slate-50 via-white to-emerald-50 flex items-center justify-center p-4 relative overflow-hidden">
      ...
      >
            ...
            {success && (
              ...
              >
                <motion.div
                  ...
                  className="w-16 h-16 bg-zen-primary/10 rounded-full flex items-center justify-center mb-4"
                >
          ...
          {!success && (
            <>
              ...
              <motion.button
                ...
                disabled={loading}
                className="w-full flex items-center justify-center gap-3 p-4 bg-white border border-gray-200 rounded-2xl font-medium text-gray-700 hover:bg-gray-50 hover:border-gray-300 transition-all disabled:opacity-50 disabled:cursor-not-allowed"
              >
              ...
              <form onSubmit={handleEmailAuth} className="space-y-4">
                ...
                <div className="relative">
                  ...
                  <input
                    ...
                    required
                    minLength={6}
                    className="w-full pl-12 pr-12 py-4 bg-gray-50 border border-gray-200 rounded-2xl text-gray-900 placeholder:text-gray-400 focus:outline-none focus:ring-2 focus:ring-zen-primary/20 focus:border-zen-primary transition-all"
                  />
                  <button
                    type="button"
        ...
        <p className="text-center text-gray-400 text-sm mt-6">
          ...
          <Link href="/terms" className="text-gray-600 hover:text-zen-primary">Terms</Link>
          {" "}and{" "}
          <Link href="/privacy" className="text-gray-600 hover:text-zen-primary">Privacy Policy</Link>
        </p>
      </motion.div>
    </div>
  );
